...
def demo_select_wtf():
    ...
    # Objet formulaire pour montrer une liste déroulante basé sur la table "t_donneur"
    ...
    try:
        ...
        if request.method == "GET":
            ...
            # genre_val_list_dropdown = [(i["id_donneur"], i["intitule_genre"]) for i in data_genres]
